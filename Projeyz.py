...
file_path='C:/Users/Gürkan/Desktop/Yapay Zeka Proje/data'

    #Verilerin Bölünmesi
import splitfolders
splitted_folder='C:/Users/Gürkan/Desktop/Yapay Zeka Proje/splitted_folder'
...
#Bölünen verilerin depolanması
train_file_path = 'C:/Users/Gürkan/Desktop/Yapay Zeka Proje/splitted_folder/train'
test_file_path =  'C:/Users/Gürkan/Desktop/Yapay Zeka Proje/splitted_folder/test'
val_file_path =  'C:/Users/Gürkan/Desktop/Yapay Zeka Proje/splitted_folder/val'
#kontrol1=os.listdir("C:/Users/Gürkan/Desktop/Yapay Zeka Proje/splitted_folder/val/Blight")
#kontrol2=os.listdir("C:/Users/Gürkan/Desktop/Yapay Zeka Proje/splitted_folder/val/Common_Rust")
#kontrol3=os.listdir("C:/Users/Gürkan/Desktop/Yapay Zeka Proje/splitted_folder/val/Gray_Leaf_Spot")
#kontrol4=os.listdir("C:/Users/Gürkan/Desktop/Yapay Zeka Proje/splitted_folder/val/Healthy")

#Verilerin işlenmesi ve oranlarına göre dağıtımı
#Hiper parametreler batch_size, suffle 
...
#Verilerin kaçar adet olduğunun tabloda görüntülenmesi
...
def configure_model():
    #modelin boyutlandırılması ve renk ayarı
...
#öğrenme oranı basic değer olarak 0.001 verilmiştir.
...
#Gerçek değerlerin ve eğitim sonunda test edilen sonuçların ekrana yazdırılması "KARIŞIKLIK MATRİSİ"
...
#Test İçin Her hastalıktan örnek alınarak sonuca bakmak

# sample1 = random.choice(kontrol1)
# image1 = load_img("C:/Users/Gürkan/Desktop/Yapay Zeka Proje/splitted_folder/val/Blight/"+sample1)
# plt.title("Blight Örneği")
# plt.imshow(image1)

# sample2 = random.choice(kontrol2)
# image2 = load_img("C:/Users/Gürkan/Desktop/Yapay Zeka Proje/splitted_folder/val/Common_Rust/"+sample2)
# plt.title("Common_Rust Örneği")
# plt.imshow(image2)

# sample3 = random.choice(kontrol3)
# image3 = load_img("C:/Users/Gürkan/Desktop/Yapay Zeka Proje/splitted_folder/val/Gray_Leaf_Spot/"+sample3)
# plt.title("Gray_Leaf_Spot Örneği")
# plt.imshow(image3)

# sample4 = random.choice(kontrol4)
# image4 = load_img("C:/Users/Gürkan/Desktop/Yapay Zeka Proje/splitted_folder/val/Healthy/"+sample4)
# plt.title("Healthy Örneği")
# plt.imshow(image4)
